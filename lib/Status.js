...
module.exports = 
{
	...
	NetStream:
	{
		...
		Publish:
		{
			...
			Rejected	: new Status("NetStream.Publish.Rejected"			,"status"),
			Denied		: new Status("NetStream.Publish.Denied"				,"status"),
		},
		Record:
		{
		...
		Unpublish:
		{
			Success		: new Status("NetStream.Unpublish.Success"			,"status"),	//The unpublish operation was successful.
